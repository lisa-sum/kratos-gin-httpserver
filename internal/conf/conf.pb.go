...
type Database struct {
	...
	Postgres *Database_Postgres `protobuf:"bytes,1,opt,name=postgres,proto3" json:"postgres,omitempty"`
	Redis    *Database_Redis    `protobuf:"bytes,2,opt,name=redis,proto3" json:"redis,omitempty"`
}
...
func (x *Database) GetRedis() *Database_Redis {
	if x != nil {
		return x.Redis
	}
	return nil
...
func (x *Database_Postgres) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *Database_Postgres) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
func (x *Database_Postgres) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *Database_Postgres) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
func (x *Database_Postgres) GetSslMode() string {
	if x != nil {
		return x.SslMode
	}
	return ""
...
func (x *Database_Postgres) GetTimeZone() string {
	if x != nil {
		return x.TimeZone
	}
	return ""
...
func (x *Database_Redis) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Database_Redis) ProtoMessage() {}

func (x *Database_Redis) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Database_Redis.ProtoReflect.Descriptor instead.
func (*Database_Redis) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Database_Redis) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Database_Redis) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Database_Redis) GetReadTimeout() *durationpb.Duration {
	if x != nil {
...
func (x *Database_Redis) GetWriteTimeout() *durationpb.Duration {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x30, 0x0a, 0x08, 0x64, 0x61, 0x74, 0x61, 0x62, 0x61,
	...
	0x64, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72,
	...
	0x6f, 0x75, 0x74, 0x22, 0xe2, 0x03, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x12, 0x39, 0x0a, 0x08, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01,
	...
	0x73, 0x52, 0x08, 0x70, 0x6f, 0x73, 0x74, 0x67, 0x72, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x05, 0x72,
	0x65, 0x64, 0x69, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6b, 0x72, 0x61,
	0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x52, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x1a, 0xb2, 0x01,
	...
	0x64, 0x62, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x73,
	0x6c, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x73, 0x73,
	0x6c, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x7a, 0x6f,
	0x6e, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x5a, 0x6f,
	0x6e, 0x65, 0x1a, 0xb3, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18, 0x0a, 0x07,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x1b, 0x5a, 0x19, 0x74, 0x69, 0x6b, 0x74,
	0x6f, 0x6b, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e, 0x66,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Database_Postgres)(nil),   // 5: kratos.api.Database.Postgres
	(*Database_Redis)(nil),      // 6: kratos.api.Database.Redis
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Database.postgres:type_name -> kratos.api.Database.Postgres
	6,  // 5: kratos.api.Database.redis:type_name -> kratos.api.Database.Redis
	...
	7,  // 8: kratos.api.Database.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: kratos.api.Database.Redis.write_timeout:type_name -> google.protobuf.Duration
